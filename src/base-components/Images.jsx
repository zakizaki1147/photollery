  ...
  return (
    <>
      {photos.map((photo) => (
        <div
          key={photo.FotoID}
          className="relative group/1 rounded-xl overflow-hidden bg-gray-100 border-2 border-transparent hover:border-primary"
        ...
        >
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0 bg-black opacity-0 flex items-end group-hover/1:opacity-30 transition-opacity duration-300 cursor-pointer"></div>
          <div className='absolute bottom-0 w-full h-16 flex justify-end items-center px-5 opacity-0 group-hover/1:opacity-100 duration-300 cursor-pointer'>
  ...
  return (
    <>
      <div className="w-full h-60 relative group rounded-xl overflow-hidden bg-gradient-to-tr from-secondary to-primary flex gap-0.5 border-2 border-primary cursor-pointer">
        ...
        <div className="absolute inset-0 bg-black opacity-0 flex items-end group-hover:opacity-20 transition-opacity duration-300 cursor-pointer"></div>
